...
export default function Consultant(){
    ...
    useEffect(() => {
          ...
          const fetchUsers = async () => {
               const response = await dispatch(getUserr('consultant'));
    ...
    const header = (
          ...
          <h4 className="m-0">Manage Consultants</h4>
          ...
          <>
               <div>
                    <div className=" w-full bg-bg_dash md:w-120 lg:w-120 scrollbar-thin hover:scrollbar-thumb-gray-200 scrollbar-track-gray-300 h-[698px] overflow-auto mt-1">
                         <div>
                              <p className="text-xl text-green-800 font-semibold py-6">Consultants</p>
                         </div>
