...
import { createProduct, getProduct, updateProduct } from '../../../redux/feature/productSlice';
...
const EditProductModal = ({ isOpen, onClose, product }) => {
    ...
    const validationSchema = Yup.object().shape({
        ...
        category: Yup.string(),
        stockQuantity: Yup.number().min(0, "Cannot be negative"),
    ...
    console.log("Form submitted with values:", values); 
        ...
        try {
            const response = await dispatch(updateProduct(product._id, formData));
        ...
        <div id="backdrop" onClick={handleOnBackGropClick} className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
            ...
            <div className="bg-white rounded-lg p-6 w-[70%] h-[700px] overflow-y-auto shadow-lg">
                ...
                <form className="w-full h-full flex-auto" onSubmit={formik.handleSubmit}>
                    ...
                    <div className='flex gap-4 py-2'>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onBlur={formik.handleBlur}
                                multiple
                                className="mt-1 block w-full file:border-none file:bg-orange-400 file:h-11  file:text-white h-11 border border-gray-300 rounded-md shadow-sm"
                            />
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onBlur={formik.handleBlur}
                                multiple
                                className="mt-1 block w-full file:border-none file:h-11 file:bg-orange-400 file:text-white h-11 border border-gray-300 rounded-md shadow-sm"
                            />
                        </div>
                    </div>
                    ...
                    <button type="submit" className=" font-bold mt-6 px-6 py-2 w-full bg-orange-500 text-white rounded-md">
                        UPDATE
                    </button>
                </form>
            </div>
