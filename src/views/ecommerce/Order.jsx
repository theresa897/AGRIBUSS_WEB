...
import { BsArrowDown, BsArrowRightCircle, BsCheck, BsCircleFill, BsEye, BsFilter, BsSearch } from 'react-icons/bs';
...
export default function Order() {
    ...
    const handleTrackOrder = (order) => {
        navigate('/market/track-order', { state: { order } });
    };
    ...
    return (
        <div>
            ...
            <div className='px-4 md:px-12 py-8 h-screen bg-gray-50'>
                {notification && (
                    <div className="bg-green-500 text-white p-3 rounded-lg mb-4">
                        {notification}
                    </div>
                )}
                <p className="text-2xl pb-4 font-bold">Your orders</p>
                            ...
                            <table className='min-w-full'>
                                <thead className='text-xs text-left text-gray-500 font-medium'>
                                    <tr>
                                        ...
                                        <th className='bg-gray-200 rounded-se-lg'>Actions</th>
                                    </tr>
                                </thead>
                                            ...
                                            <tr key={index} className={`${index % 2 !== 0 ? 'bg-gray-50' : ''} text-sm p-2`}>
                                                ...
                                                <td className='flex gap-2'>
                                                    <div
                                                        ...
                                                        className='text-white bg-green-500 p-2 px-3 my-3 cursor-pointer rounded-full'
                                                        title="View Order Details"
                                                    >
                                                        <BsEye size={18} className='my-1' />
                                                    </div>
                                                    <div
                                                        onClick={() => handleTrackOrder(product.id)}
                                                        className='text-white bg-orange-500 p-2 px-3 my-3 cursor-pointer rounded-full'
                                                        title="Track Order"
                                                    >
