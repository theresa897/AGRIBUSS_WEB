...
export default function Farmer(){
    ...
    useEffect(() => {
          ...
          const fetchUsers = async () => {
               const response = await dispatch(getUserr('farmer'));
    ...
    //       axios.get("http://localhost:4000/api/users/role")
    //       .then((response)=>{
    //                 console.log(response.data.data.users)
    //                 return setFarmers(response.data.data.users)
    //       })
    //  },[])
