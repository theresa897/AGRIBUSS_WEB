...
import {BsChevronCompactRight,BsPlusLg, BsActivity, BsPeopleFill, BsCart4, BsBag,BsCircleFill, BsPersonFill,BsBoxes, BsSignTurnRight,BsCalendar4Week, BsChevronCompactLeft, BsStarFill} from 'react-icons/bs'
...
// import {cardAData} from '../Utils/CardData.jsx'
import React, { useState, useEffect } from 'react';
import { Chart } from 'primereact/chart';
import { Timeline } from 'primereact/timeline';
import { useDispatch, useSelector } from 'react-redux';
import { allUsers, getAllUser } from '../redux/feature/userSlice.js';
...
export default function LeftADash(){
    ...
    useEffect(() => {
	    const fetchProducts = async () => {
	        ...
	        // Define role IDs
	        const roleIDs = {
	            farmer: "66d5c7df66f805305455e17f",
	            driver: "66d5c7df66f805305455e181", // replace with actual driver role ID
	            consultant: "66d5c7df66f805305455e180", // replace with actual consultant role ID
	            client: "66d5c7df66f805305455e17e", // replace with actual client role ID
	        };

	        const farmers = data.filter(i => i.roles === roleIDs.farmer);
	        const drivers = data.filter(i => i.roles === roleIDs.driver);
	        const consultants = data.filter(i => i.roles === roleIDs.consultant);
	        const clients = data.filter(i => i.roles === roleIDs.client);
	...
	return(
		<>
			<div className=" w-full bg-bg_dash md:w-120 lg:w-120 scrollbar-thin hover:scrollbar-thumb-gray-200 scrollbar-track-gray-300 h-[698px] overflow-auto mt-1 ">
				...
				<div className="flex flex-row gap-4 w-full h-[450px] py-4">
